...
import tankserver.Shot;
import tankserver.Game;
public class TanksGameServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            while (true) {
                Game game = new Game();
                Game.Player playerX = game.new Player(listener.accept(), "1", shots);
                Game.Player playerO = game.new Player(listener.accept(), "2", shots);
...
// 			TanksGameServer.shots++;
// 			String positions[] = cadena.split(" ");
// 			s = new Shot(Integer.parseInt(positions[3]),Integer.parseInt(positions[1]),Integer.parseInt(positions[2]), output, opponent.output, TanksGameServer.shots, opponent.x, opponent.y);
// 			shot = new Thread(s);
// 			shot.start();
// 			output.println(cadena + " " + TanksGameServer.shots);
// 			opponent.output.println(cadena + " " + TanksGameServer.shots);
// 		    }
// 		    else{
